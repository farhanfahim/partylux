...
abstract class PagedView<T> extends StatefulWidget {
  ...
  final void Function(PageModel<T> items)? onDispose;
...
abstract class PagedViewState<T> extends State<PagedView<T>> {
  ...
  void reloadPage() {
    ...
    if (pagingController.itemList == null) {
      pagingController.notifyPageRequestListeners(_page);
    } else {
