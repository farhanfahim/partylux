...
class ReservationTile extends StatelessWidget {
  ...
  final Function(OrderModel event,String type)? callback;
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: AppText(
                          text: DateTimeUtil.parseDateTime(data.event!.startDateTime!,DateTimeUtil.serverDateTimeFormat2,'EEEE, d MMM y',isutc: true),
                      ...
                      AppText(
                        text: DateTimeUtil.parseDateTime(data.event!.startDateTime!,DateTimeUtil.serverDateTimeFormat2,'h:mm a',isutc: true),
                        fontSize: AppSizer.getFontSize(AppDimen.fontTextfieldLabel14),
                        fontWeight: FontWeight.w400,
                        color: AppColors.iconColor,
                      ),
                    ...
                    children: [
                      ...
                      AppText(
                        text:currentUserGender.toLowerCase() == "male"
                            ? data.event!.maleFee!?"Free":"\$ ${data.event!.maleAmount!.toStringAsFixed(2)}"
                            : data.event!.femaleFee!?"Free":"\$ ${data.event!.femaleAmount!.toStringAsFixed(2)}",
